$(document).ready(function() {
    ...
    $('#submitOrder').click(function() {
        ...
        if (currentWeek < 12) {
            currentWeek++;
            if (currentWeek > 1) {
                $('#lastWeekDemandSimulate').text(weeks[currentWeek - 1].customerDemand);
            }
            ...
            if (currentWeek === 1) {
                ...
                weeks[currentWeek].holdingCosts =
                    Math.ceil(weeks[currentWeek].quantityOrdered * inputHoldingCost);
                ...
                weeks[currentWeek].orderCosts =
                    weeks[currentWeek].quantityOrdered > 0 ? inputOrderingCost : 0;
                weeks[currentWeek].holdingCosts = Math.ceil(weeks[currentWeek].quantityOrdered * inputHoldingCost);
    ...
    $('#finishSimulation').click(function() {
        ...
        if (confirm('Are you sure you want to finish the simulation? Your work will be lost.')) {
            // Save it!
            window.location.href = "https://eiu-inventory-basics-simulator.netlify.app/"
        } else {
            // Do nothing!
